...
#define PIN_EYE_R    7
#define PIN_JAW      8
#define PIN_HEAD_ROT 9
#define PIN_NECK_UD  10
#define PIN_NECK_LR  11

// Servo objects
Servo servoEyeL, servoEyeR, servoJaw, servoHeadRot, servoNeckUD, servoNeckLR;
...
ServoMap servos[] = {
    ...
    {"jaw",     servoJaw,     90, 90},
    {"headRot", servoHeadRot, 90, 90},
    {"neckUD",  servoNeckUD,  90, 90},
    {"neckLR",  servoNeckLR,  90, 90}
};
...
void setup() {
    ...
    servoHeadRot.attach(PIN_HEAD_ROT);
    servoNeckUD.attach(PIN_NECK_UD);
    servoNeckLR.attach(PIN_NECK_LR);
