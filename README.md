...
![Circuit Schematic](docs/images/circuit-schematic.png)
...
```
                          ...
                          │   D6 ──── 220Ω ────►  🔵 RGB B                  │
                          │                                                 │
                          │   D4 ──────────────►  👁️  Servo L (Левый глаз)  │
                          │   D7 ──────────────►  👁️  Servo R (Правый глаз) │
                          │   D8 ──────────────►  🦷  Servo J (Челюсть)     │
                          │                                                 │
                          │   5V ──────┬────────── VCC сервоприводов         │
                          │   GND ─────┴────────── GND сервоприводов         │
                          │                                                 │
                          │   USB ──── Raspberry Pi (/dev/ttyUSB0)          │
                          └─────────────────────────────────────────────────┘
                                         │
                                         │ USB
                                         ▼
                          ...
                          │                                  │
                          │   USB ──── Arduino Mega (Тело)   │
                          └─────────────────────────────────┘

                          ┌─────────────────────────────────┐
                          │     Внешнее питание 5-6V        │
                          │      (2A min на серво)           │
                          │                                  │
                          │   +5V ──────► VCC сервоприводов   │
                          │   GND ──────► Общая земля        │
